  ...
  return (
    ...
    >
      <div className="flex flex-col bg-black text-white">
        {/* 1) ROBOT HERO – exactly one screen tall */}
        <section className="min-h-screen flex flex-row items-center">
          {/* Left side - Text */}
        ...
        {/* 2) SERVICES – normal full-width section */}
        <section>
          <Services />
        </section>

        {/* 3) CONTACT – normal full-width section */}
        <section>
          <Contact />
        </section>
      </div>
