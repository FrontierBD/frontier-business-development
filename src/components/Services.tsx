...
const services = [
  {
    ...
    description:
      "Building fast, modern websites that capture attention and drive conversions. Each site is optimized for SEO (Search Engine Optimization) and built to grow with your business.",
    features: [
      "Responsive design",
