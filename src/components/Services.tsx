...
const services = [{
  ...
  features: ["Responsive design", "SEO (Search Engine Optimization) keyword targeting", "Google Analytics integration"]
}, {
  icon: Bot,
          ...
          boxShadow: '0 4px 20px rgba(0, 74, 173, 0.08)'
              ...
              <CardContent className="p-6 md:p-8 space-y-4 relative z-10">
                ...
                <ul className="space-y-2 pt-2">
                  {service.features.map((feature, idx) => <li key={idx} className="flex items-start gap-2 group/item">
