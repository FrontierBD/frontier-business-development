            ...
            <Card className="border-border bg-card hover:shadow-glow transition-all duration-300">
              <CardContent className="p-6 flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">info@frontier.ca</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-border bg-card hover:shadow-glow transition-all duration-300">
              <CardContent className="p-6 flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">+1 (902) 555-0123</p>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="lg:col-span-2 border-border bg-card shadow-card animate-fade-in-up">
            <CardContent className="p-6 md:p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                      placeholder="Website Design, SEO, etc."
                      className="bg-background border-border"
                    />
                  </div>
                </div>
                ...
                <Button
                  type="submit"
                  className="w-full bg-primary hover:bg-primary-light shadow-glow transition-all duration-300 hover:scale-105"
                  size="lg"
                >
                  Send Message
                </Button>
